...
//       {/* Preview Vizual */}
//       <section className="flex flex-col md:flex-row items-start justify-center gap-12 mb-20 max-w-6xl mx-auto px-4">
//   <img
...
export default function Home() {
  return (
    <div className="center-page bg-[#2a2a36] text-white">
      <div style={{ maxWidth: '800px', width: '100%', textAlign: 'center' }}>
        <h1 style={{ fontSize: '2.5rem', color: '#e9c703' }}>Test Centrare HARD</h1>
        <p style={{ marginTop: '1rem', color: '#e9c703' }}>
          Acum containerul este 100% centrat cu CSS clasic.
        </p>
        <img
          src="https://via.placeholder.com/300x200"
          alt="Preview"
          style={{ margin: '2rem auto', borderRadius: '12px', boxShadow: '0 0 20px #000' }}
        />
      </div>
    </div>
  );
