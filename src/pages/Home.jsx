  ...
  return (
    <div className="home-page p-6 text-white min-h-screen">
      <header className="text-center mb-10">
        ...
        <p className="text-lg mt-4 text-gray-300">Ține evidența progresului tău de fitness și atinge-ți obiectivele!</p>
      </header>

      <section className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
        <div className="bg-[#333] p-6 rounded-2xl shadow-lg hover:scale-105 transition">
